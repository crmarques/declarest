...
vault_address=$(e2e_require_env 'DECLAREST_E2E_VAULT_ADDRESS') || exit 1
vault_mount=$(e2e_env_optional 'DECLAREST_E2E_VAULT_MOUNT' || true)
vault_mount=${vault_mount:-secret}
vault_path_prefix=$(e2e_env_optional 'DECLAREST_E2E_VAULT_PATH_PREFIX' || true)
vault_path_prefix=${vault_path_prefix:-declarest-e2e}
vault_kv_version=$(e2e_env_optional 'DECLAREST_E2E_VAULT_KV_VERSION' || true)
vault_kv_version=${vault_kv_version:-2}

vault_token=$(e2e_env_optional 'DECLAREST_E2E_VAULT_TOKEN' || true)
vault_username=$(e2e_env_optional 'DECLAREST_E2E_VAULT_USERNAME' || true)
vault_password=$(e2e_env_optional 'DECLAREST_E2E_VAULT_PASSWORD' || true)
vault_role_id=$(e2e_env_optional 'DECLAREST_E2E_VAULT_ROLE_ID' || true)
vault_secret_id=$(e2e_env_optional 'DECLAREST_E2E_VAULT_SECRET_ID' || true)
vault_auth_mount=$(e2e_env_optional 'DECLAREST_E2E_VAULT_AUTH_MOUNT' || true)
