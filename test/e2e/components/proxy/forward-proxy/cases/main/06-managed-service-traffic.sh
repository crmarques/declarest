...
CASE_ID='proxy-managed-service-traffic'
CASE_SCOPE='main'
CASE_REQUIRES='proxy-mode=local managed-service=simple-api-server'
...
case_run() {
  ...
  case_wait_until 20 1 "proxy log contains managed-service path ${logical_path}" \
