...
rundeck_base_url=$(e2e_require_env 'DECLAREST_E2E_MANAGED_SERVER_BASE_URL') || exit 1
rundeck_token=$(e2e_require_env 'DECLAREST_E2E_MANAGED_SERVER_TOKEN') || exit 1
rundeck_api_version=$(e2e_env_optional 'DECLAREST_E2E_MANAGED_SERVER_RUNDECK_API_VERSION' || true)
rundeck_api_version=${rundeck_api_version:-45}
rundeck_auth_header=$(e2e_env_optional 'DECLAREST_E2E_MANAGED_SERVER_RUNDECK_AUTH_HEADER' || true)
