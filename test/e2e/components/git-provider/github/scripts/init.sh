...
github_remote_url=$(e2e_require_env 'DECLAREST_E2E_GITHUB_REMOTE_URL') || exit 1
github_token=$(e2e_require_env 'DECLAREST_E2E_GITHUB_TOKEN') || exit 1
github_remote_branch=$(e2e_env_optional 'DECLAREST_E2E_GITHUB_REMOTE_BRANCH' || true)
