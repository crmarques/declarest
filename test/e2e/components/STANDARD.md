...
- Resource-server fixture metadata files (`*/_/metadata.yaml` or `*/_/metadata.json`) MUST include non-empty `resourceInfo.idFromAttribute` and `resourceInfo.aliasFromAttribute`; YAML is preferred for new fixtures.
