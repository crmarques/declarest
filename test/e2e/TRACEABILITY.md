...
| Managed-service auth modes and mTLS | N/A | `test/e2e/components/managed-service/simple-api-server/cases/main/07-oauth2-auth-contract.sh`, `test/e2e/components/managed-service/simple-api-server/cases/main/08-basic-auth-contract.sh`, `test/e2e/components/managed-service/simple-api-server/cases/corner/07-mtls-trust-reload.sh` |
