...
case_run() {
  ...
  case_run_declarest resource list /customers-recursion --source repository -o json
  case_expect_success
  ...
  case_run_declarest resource list /customers-recursion --source repository -r -o json
  case_expect_success
