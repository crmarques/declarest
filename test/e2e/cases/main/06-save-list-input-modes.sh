...
case_run() {
  ...
  case_run_declarest resource get /save-input-modes-items/alpha --local -o json
  case_expect_success
  ...
  case_run_declarest resource get "${as_one_resource_path}" --local -o json
  case_expect_success
  ...
  case_run_declarest resource get "${as_one_resource_path}/alpha" --local
  case_expect_failure
