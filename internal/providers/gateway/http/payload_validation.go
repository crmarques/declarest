...
func (g *HTTPResourceGateway) validateOperationPayload(
	ctx context.Context,
...
func (g *HTTPResourceGateway) validateOperationAssertions(
	ctx context.Context,
...
func (g *HTTPResourceGateway) validateOperationSchemaRef(
	ctx context.Context,
	payload resource.Value,
...
func (g *HTTPResourceGateway) resolveOpenAPISchemaForValidation(
	ctx context.Context,
	requestPath string,
	requestMethod string,
	schemaRef string,
	...
	if schemaRef == "openapi:request-body" {
		...
		if method == "" {
			return nil, nil, faults.NewValidationError("request method is required for OpenAPI request-body validation", nil)
		}
