...
func (g *HTTPResourceGateway) Request(
	ctx context.Context,
	method string,
	endpointPath string,
	body resource.Value,
...
func (g *HTTPResourceGateway) execute(ctx context.Context, spec metadata.OperationSpec) ([]byte, http.Header, error) {
...
func (g *HTTPResourceGateway) newRequest(ctx context.Context, spec metadata.OperationSpec) (*http.Request, error) {
...
func (g *HTTPResourceGateway) resolveRequestURL(requestPath string, query map[string]string) (string, error) {
