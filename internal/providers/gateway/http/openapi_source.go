...
func (g *HTTPResourceGateway) GetOpenAPISpec(ctx context.Context) (resource.Value, error) {
...
func (g *HTTPResourceGateway) openAPIDocument(ctx context.Context) (map[string]any, error) {
...
func (g *HTTPResourceGateway) loadOpenAPIDocument(ctx context.Context) (map[string]any, error) {
