...
func (g *HTTPResourceGateway) applyOperationPayloadTransforms(
	ctx context.Context,
	payload any,
...
func (g *HTTPResourceGateway) applyPayloadJQ(ctx context.Context, payload resource.Value, expression string) (resource.Value, error) {
