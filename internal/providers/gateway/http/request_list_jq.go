...
func (g *HTTPResourceGateway) applyListJQ(ctx context.Context, payload any, expression string) (any, error) {
...
func (g *HTTPResourceGateway) compileListJQCode(ctx context.Context, expression string) (*gojq.Code, error) {
...
func (g *HTTPResourceGateway) listJQResourceFunction(ctx context.Context) func(any, []any) any {
...
func (g *HTTPResourceGateway) resolveListJQResource(ctx context.Context, logicalPath string) (resource.Value, error) {
	resolved, found, err := gatewaydomain.ResolveListJQResource(ctx, logicalPath)
	if err != nil {
		return nil, err
	}
	if !found {
