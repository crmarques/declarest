...
func (g *HTTPResourceGateway) applyOpenAPIFallback(
	ctx context.Context,
	requestPath string,
...
func (g *HTTPResourceGateway) validateOpenAPIMethodSupport(ctx context.Context, requestPath string, method string) error {
	if strings.TrimSpace(g.openAPISource) == "" {
		return nil
	}
