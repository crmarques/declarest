...
func TestResourceSourceFlagCompletionShowsSupportedValues(t *testing.T) {
	...
	if !strings.Contains(output, "repository") || !strings.Contains(output, "managed-service") {
...
func TestPathCompletionResourceSourceFlagsSwitchCompletionTarget(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:            "get_managed_service_prefers_remote",
			args:            []string{"resource", "get", "--source", "managed-service", "/customers"},
			expectLocal:     false,
			expectRemote:    true,
			expectedSnippet: "/customers/",
		},
		...
		{
			name:            "list_managed_service_prefers_remote",
			args:            []string{"resource", "list", "--source", "managed-service", "/customers"},
			expectLocal:     false,
			expectRemote:    true,
			expectedSnippet: "/customers/",
		},
		{
			...
			args:            []string{"resource", "delete", "--yes", "--source", "repository", "/customers"},
			expectLocal:     true,
			expectRemote:    false,
			expectedSnippet: "/customers/",
		},
		{
			name:            "delete_managed_service_prefers_remote",
			args:            []string{"resource", "delete", "--yes", "--source", "managed-service", "/customers"},
			expectLocal:     false,
			expectRemote:    true,
			expectedSnippet: "/customers/",
		},
		{
			...
			args:            []string{"resource", "delete", "--yes", "--source", "both", "/customers"},
			expectLocal:     true,
			expectRemote:    true,
			expectedSnippet: "/customers/",
		},
