...
repo_provider_env_file() {
    printf "%s/gitlab.env" "$DECLAREST_WORK_DIR"
}

repo_provider_map_env() {
    export DECLAREST_REPO_BASIC_URL="${DECLAREST_GITLAB_BASIC_URL:-}"
    export DECLAREST_REPO_PAT_URL="${DECLAREST_GITLAB_PAT_URL:-}"
    export DECLAREST_REPO_SSH_URL="${DECLAREST_GITLAB_SSH_URL:-}"
    export DECLAREST_REPO_BASIC_USER="${DECLAREST_GITLAB_USER:-}"
    export DECLAREST_REPO_BASIC_PASSWORD="${DECLAREST_GITLAB_PASSWORD:-}"
    export DECLAREST_REPO_PAT_TOKEN="${DECLAREST_GITLAB_PAT:-}"
...
repo_provider_apply_env() {
    ...
    export DECLAREST_REPO_PROVIDER="gitlab"
    export DECLAREST_REMOTE_REPO_PROVIDER="gitlab"
