...
## Workflow
1. Load `agents/reference/interfaces.md` before editing any domain file.
2. Use `agents/skills/spec-writer/templates/domain-template.md` for each domain document.
...
6. Update `AGENTS.md` load matrix when adding or renaming domain files.
