...
### E2E Harness
15. E2E profiles: `cli-basic|cli-full|cli-manual|operator-manual|operator-basic|operator-full` workload behavior, `smoke|main|operator-main|corner` case selection, `CASE_PROFILES` family filtering, deterministic step statuses, manual-profile managed-service access handoff details, and operator-profile installation/handoff/automation validation.
