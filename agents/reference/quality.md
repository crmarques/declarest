...
10. E2E harness tests verify operator profile defaulting/validation (`repo-type=git`, `git-provider=gitea`) and in-cluster operator deployment lifecycle behavior (runtime details, handoff commands, and cleanup/teardown).
