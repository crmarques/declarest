...
- **Stable logical paths** — use `/path/to/resource` instead of raw endpoint URLs
...
- **Compact repository layout** — metadata-backed defaults keep shared values out of repository
